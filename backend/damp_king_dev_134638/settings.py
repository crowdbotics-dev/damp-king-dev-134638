"""
Django settings for damp_king_dev_134638 project.
...
ROOT_URLCONF = 'damp_king_dev_134638.urls'
...
WSGI_APPLICATION = 'damp_king_dev_134638.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "damp_king_dev_134638 API",
    "DESCRIPTION": "API documentation for damp_king_dev_134638 App",
    "VERSION": "v1",
}
